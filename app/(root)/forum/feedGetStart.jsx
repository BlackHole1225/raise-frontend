...
const FeedGetStart = () => {
    return (
        <article className="flex md:h-[205px] w-full flex-col bg-brand-olive-green  py-[30px] px-[22px] gap-2">
            <h2 className="text-2xl md:text-[32px] font-bold tracking-wider uppercase text-brand-lemon-yellow font-heading">
