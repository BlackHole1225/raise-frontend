...
const RichTextEditor = ({ placeholder }) => {
  ...
  return (
    <div className="border border-brand-dark rounded-md shadow-sm h-[300px]">
      <div className="flex items-center p-2 border-b border-brand-dark flex-wrap">
        <select
          className="mr-2 p-1 bg-brand-lemon-yellow   rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
